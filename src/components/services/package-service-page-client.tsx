...
interface PackageServicePageClientProps {
  service: ServiceData;
}

export default function PackageServicePageClient({
  service,
}: PackageServicePageClientProps) {
      ...
      <div className="px-[10px] md:px-5">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-[10px]">
            {service.advantagesSection?.advantages?.map((advantage) => (
              <div
                key={advantage.id}
