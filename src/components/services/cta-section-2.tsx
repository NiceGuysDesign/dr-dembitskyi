...
export default function CTASection2() {
  ...
  return (
    <section className="relative h-[100vh] md:h-[50vh] lg:h-[100vh] w-full overflow-hidden">
      {/* Background gradient blur effect - lower z-index */}
      <div className="absolute bottom-40 md:bottom-0 left-0 right-0 bg-gradient-to-t from-[#F4F4F5] to-transparent w-full h-[50vh] md:h-[300px] z-[30]"></div>

      {/* Right side - Image (absolute positioned, fixed to bottom of section) */}
      <div className="absolute right-0 bottom-40 md:bottom-0 md:z-20 z-0 w-full h-[70vh] sm:h-[80vh] md:w-[400px] md:h-[600px] lg:w-[600px] lg:h-[700px] 2xl:w-[1021px] 2xl:h-[100vh] pointer-events-none lg:pointer-events-auto">
        <Image
      ...
      <div className="px-[10px] md:px-5 py-10 md:py-20 relative z-40 md:z-10 h-full flex flex-col justify-center md:justify-start">
        <div className="relative z-10">
          ...
          <div className="flex flex-col gap-6 lg:gap-8">
            {/* Title 1 */}
            <h2 className="relative z-10 md:z-[-1] font-manrope font-bold text-[10vw] md:text-[84px] lg:text-[108px] xl:text-[122px] 2xl:text-[179px] leading-[100%] tracking-[-0.05em] text-[#353556] flex flex-col">
